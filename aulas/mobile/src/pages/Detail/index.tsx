    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            <View style={styles.container}>
                ...
                <Image style={styles.pointImage} source={{ uri: 'https://blog.rcky.com.br/wp-content/uploads/2020/01/minimercado.jpg' }} />

                <Text style={styles.pointName}>Mercado do jão</Text>
                <Text style={styles.pointItems}>Lamapdas, oleo de coinha</Text>
